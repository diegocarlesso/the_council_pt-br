...
> Gerado automaticamente por `progress_report.py` em 2026-08-05 09:36. Não edite à mão — rode o script de novo depois de cada lote validado.
...
- Já resolvidas (draft ou approved na TM): **8393** (38.5%)
- Restam: **13413**
- Por status: {'approved': 13, 'draft': 8379, 'needs_review': 1}
...
**Diálogo** — 13390 strings pendentes nesta categoria. Comando:
```bash
python translate_batch.py --category "Diálogo" --batch-size 60 --max-batches 1 --dry-run
```
