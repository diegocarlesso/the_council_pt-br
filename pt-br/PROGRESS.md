...
> Gerado automaticamente por `progress_report.py` em 2026-08-17 12:51. Não edite à mão — rode o script de novo depois de cada lote validado.
...
- Já resolvidas (draft ou approved na TM): **17067** (78.3%)
- Restam: **4739**
- Por status: {'approved': 13, 'draft': 17003, 'needs_review': 51}
...
**Diálogo** — 4716 strings pendentes nesta categoria. Comando:
```bash
python translate_batch.py --category "Diálogo" --batch-size 60 --max-batches 1 --dry-run
```
