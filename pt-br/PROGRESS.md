...
> Gerado automaticamente por `progress_report.py` em 2026-08-17 18:52. Não edite à mão — rode o script de novo depois de cada lote validado.
...
- Restam: **0**
- Por status: {'approved': 13, 'draft': 21651, 'needs_review': 142}
