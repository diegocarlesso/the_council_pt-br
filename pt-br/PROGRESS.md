...
> Gerado automaticamente por `progress_report.py` em 2026-08-05 10:06. Não edite à mão — rode o script de novo depois de cada lote validado.
...
- Já resolvidas (draft ou approved na TM): **8633** (39.6%)
- Restam: **13173**
- Por status: {'approved': 13, 'draft': 8619, 'needs_review': 1}
...
**Diálogo** — 13150 strings pendentes nesta categoria. Comando:
```bash
python translate_batch.py --category "Diálogo" --batch-size 60 --max-batches 1 --dry-run
```
