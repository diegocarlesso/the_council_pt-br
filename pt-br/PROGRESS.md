...
> Gerado automaticamente por `progress_report.py` em 2026-08-04 11:51. Não edite à mão — rode o script de novo depois de cada lote validado.
...
- Já resolvidas (draft ou approved na TM): **2782** (12.8%)
- Restam: **19024**
- Por status: {'approved': 13, 'draft': 2769}
...
**Diálogo** — 18993 strings pendentes nesta categoria. Comando:
```bash
python translate_batch.py --category "Diálogo" --batch-size 60 --max-batches 1 --dry-run
```
