...
> Gerado automaticamente por `progress_report.py` em 2026-08-05 11:06. Não edite à mão — rode o script de novo depois de cada lote validado.
...
- Já resolvidas (draft ou approved na TM): **8993** (41.2%)
- Restam: **12813**
- Por status: {'approved': 13, 'draft': 8939, 'needs_review': 41}
...
**Diálogo** — 12790 strings pendentes nesta categoria. Comando:
```bash
python translate_batch.py --category "Diálogo" --batch-size 60 --max-batches 1 --dry-run
```
