...
> Gerado automaticamente por `progress_report.py` em 2026-08-17 15:52. Não edite à mão — rode o script de novo depois de cada lote validado.
...
- Já resolvidas (draft ou approved na TM): **19667** (90.2%)
- Restam: **2139**
- Por status: {'approved': 13, 'draft': 19157, 'needs_review': 497}
...
**Diálogo** — 2116 strings pendentes nesta categoria. Comando:
```bash
python translate_batch.py --category "Diálogo" --batch-size 60 --max-batches 1 --dry-run
```
