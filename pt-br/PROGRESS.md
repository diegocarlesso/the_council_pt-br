...
> Gerado automaticamente por `progress_report.py` em 2026-08-17 17:52. Não edite à mão — rode o script de novo depois de cada lote validado.
...
- Já resolvidas (draft ou approved na TM): **21627** (99.2%)
- Restam: **179**
- Por status: {'approved': 13, 'draft': 21112, 'needs_review': 502}
...
**Diálogo** — 156 strings pendentes nesta categoria. Comando:
```bash
python translate_batch.py --category "Diálogo" --batch-size 60 --max-batches 1 --dry-run
```
