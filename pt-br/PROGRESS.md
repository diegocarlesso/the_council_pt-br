...
> Gerado automaticamente por `progress_report.py` em 2026-08-17 16:52. Não edite à mão — rode o script de novo depois de cada lote validado.
...
- Já resolvidas (draft ou approved na TM): **20627** (94.6%)
- Restam: **1179**
- Por status: {'approved': 13, 'draft': 20117, 'needs_review': 497}
...
**Diálogo** — 1156 strings pendentes nesta categoria. Comando:
```bash
python translate_batch.py --category "Diálogo" --batch-size 60 --max-batches 1 --dry-run
```
