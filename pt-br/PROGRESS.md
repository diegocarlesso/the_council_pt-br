...
> Gerado automaticamente por `progress_report.py` em 2026-08-14 22:20. Não edite à mão — rode o script de novo depois de cada lote validado.
...
- Já resolvidas (draft ou approved na TM): **14707** (67.4%)
- Restam: **7099**
- Por status: {'approved': 13, 'draft': 14692, 'needs_review': 2}
...
**Diálogo** — 7076 strings pendentes nesta categoria. Comando:
```bash
python translate_batch.py --category "Diálogo" --batch-size 60 --max-batches 1 --dry-run
```
