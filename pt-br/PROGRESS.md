...
> Gerado automaticamente por `progress_report.py` em 2026-08-17 13:51. Não edite à mão — rode o script de novo depois de cada lote validado.
...
- Já resolvidas (draft ou approved na TM): **17827** (81.8%)
- Restam: **3979**
- Por status: {'approved': 13, 'draft': 17762, 'needs_review': 52}
...
**Diálogo** — 3956 strings pendentes nesta categoria. Comando:
```bash
python translate_batch.py --category "Diálogo" --batch-size 60 --max-batches 1 --dry-run
```
