...
> Gerado automaticamente por `progress_report.py` em 2026-08-14 21:20. Não edite à mão — rode o script de novo depois de cada lote validado.
...
- Já resolvidas (draft ou approved na TM): **13667** (62.7%)
- Restam: **8139**
- Por status: {'approved': 13, 'draft': 13652, 'needs_review': 2}
...
**Diálogo** — 8116 strings pendentes nesta categoria. Comando:
```bash
python translate_batch.py --category "Diálogo" --batch-size 60 --max-batches 1 --dry-run
```
