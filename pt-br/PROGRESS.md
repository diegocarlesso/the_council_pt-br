...
> Gerado automaticamente por `progress_report.py` em 2026-08-05 12:07. Não edite à mão — rode o script de novo depois de cada lote validado.
...
- Já resolvidas (draft ou approved na TM): **9473** (43.4%)
- Restam: **12333**
- Por status: {'approved': 13, 'draft': 9419, 'needs_review': 41}
...
**Diálogo** — 12310 strings pendentes nesta categoria. Comando:
```bash
python translate_batch.py --category "Diálogo" --batch-size 60 --max-batches 1 --dry-run
```
