...
> Gerado automaticamente por `progress_report.py` em 2026-08-17 19:07. Não edite à mão — rode o script de novo depois de cada lote validado.
...
- Restam: **0**
- Por status: {'approved': 75, 'draft': 21731}
